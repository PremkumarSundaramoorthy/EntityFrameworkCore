        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployedFrom = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallRecord_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CallRecord_Employee_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallRecord_CustomerId",
                table: "CallRecord",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CallRecord_EmployeeId",
                table: "CallRecord",
                column: "EmployeeId");
